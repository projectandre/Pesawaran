...
<head>
    ...
    <title>Tegineneng Penduduk Pria dan Wanita</title>
...
<body>
    ...
    <script>
        ...
        const data = {
            labels: labels,
            datasets: [{
                label: 'Jumlah Pendidikan Pria di Kecamatan Tegineneng',
        ...
        const dataP = {
            labels: labelsP,
            datasets: [{
                label: 'Jumlah Pendidikan Wanita di Kecamatan Tegineneng',
