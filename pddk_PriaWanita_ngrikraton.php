...
<body>
    <div class="row">
        <div class="col-sm-12 text-center">
            <h2><b>Jumlah Pendidikan Pria dan Wanita Kec NEGERI KATON</b></h2>
            <hr class="hrJudul">
        </div>
    </div>
    ...
    <script>
        ...
        const data = {
            labels: labels,
            datasets: [{
                label: 'Jumlah Penduduk Pria di Kecamatan NEGERI KATON',
        ...
        const dataP = {
            labels: labelsP,
            datasets: [{
                label: 'Jumlah Penduduk Wanita di Kecamatan NEGERI KATON',
