...
<head>
    ...
    <title>Gedung Tataan Penduduk Pria dan Wanita</title>
...
<body>
    <div class="row">
        <div class="col-sm-12 text-center">
            <h2><b>Jumlah Pendidikan Pria dan Wanita Kec Gedung Tataan</b></h2>
            <hr class="hrJudul">
        </div>
    </div>
    ...
    <script>
        ...
        curl_setopt($ch, CURLOPT_URL, 'https://talent.pesawarankab.go.id/api_v01/akses/jumlah/penduduk');
        ...
        const labels = [ // ['januari','februari']
            ...
            $a = 0;
            foreach ($data as $dt) {
                if ($dt['nama_kecamatan'] === "GEDONG TATAAN") {
                    $a++;
                    echo " ' " . " Des." .  $dt['nama_desa'] . " ' ";
                    echo ',';
        ...
        const data = {
            labels: labels,
            datasets: [{
                label: 'Jumlah Penduduk Pria di Kecamatan Gedong Tataan',
        ...
        const dataP = {
            labels: labelsP,
            datasets: [{
                label: 'Jumlah Penduduk Wanita di Kecamatan Gedung Tataan',
